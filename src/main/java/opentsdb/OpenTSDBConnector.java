...
public class OpenTSDBConnector {
    ...
    private static void storeListOfEventsFromMessreihe_TelenetStyle(List<opentsdb.OpenTSDBEvent> events, OpenTSDBConnector connector) throws Exception {
        ...
        try {
            ...
            for (opentsdb.OpenTSDBEvent e : events) {
    ...
    public static void storeMessreihe(TimeSeriesObject row, OpenTSDBConnector connector, long offset) throws Exception {
        ...
        List<opentsdb.OpenTSDBEvent> events = getEventsFrom(row, offset);
...
//                System.out.println(bins.readLine());
    ...
    public static void streamEventsToOpenTSDB(TimeSeriesObject row, long offset, OpenTSDBConnector connector) throws Exception {
        ...
        for (i = 0; i < DATA[0].length; i++) {
            ...
            opentsdb.OpenTSDBEvent e = new opentsdb.OpenTSDBEvent(); // TEMPLATE OBJECT
...
//            System.out.println("[LABEL] " + row.getLabel() );
        ...
        return "Transfer sucessfull. {" + nrEvents + " events }";
            ...
            String msg = "!!! Transfer FAILED !!!\n [i=" + nrEvents + "] {messae:" + ex.getMessage() + "}";

            System.out.println( "\n*** ERROR *** \n*** Please check the status of OpenTSDB server! ***\n" );
    ...
    // vi /etc/opentsdb/opentsdb.conf
    //
    private static List<opentsdb.OpenTSDBEvent> getEventsFrom(TimeSeriesObject row, long offset) throws CloneNotSupportedException {

        double resolution = 1000.0;

        // System.out.print( row );

        List<opentsdb.OpenTSDBEvent> liste = new ArrayList<opentsdb.OpenTSDBEvent>();
...
//            System.out.println("[LABEL] " + row.getLabel() );
    ...
    public static TimeSeriesObject readTimeSeriesForMetric(String metric, String aggregator, String periode, OpenTSDBConnector connector) throws Exception {
        ...
        return opentsdb.OpenTSDBResponseTransformer.getMessreiheForJSONResponse(sb.toString());
    }
    ...
    public void sendEventViaSocket(opentsdb.OpenTSDBEvent ev) throws Exception {
